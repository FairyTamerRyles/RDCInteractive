...
public class GameController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameBoard.GamePiece[,] testFullEnclosure = {{null, null, null, null, new GameBoard.GamePiece(new GameBoard.Coordinate{x = 0, y = 4}, GameBoard.PieceType.Node),  new GameBoard.GamePiece(new GameBoard.Coordinate{x = 0, y = 5}, GameBoard.PieceType.Branch), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 0, y = 6}, GameBoard.PieceType.Node), null, null, null, null},
                                                    ...
                                                    {null, null, new GameBoard.GamePiece(new GameBoard.Coordinate{x = 3, y = 2}, GameBoard.PieceType.Branch),  new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 3, y = 4}, GameBoard.PieceType.Branch), new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 3, y = 6}, GameBoard.PieceType.Branch), new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 3, y = 8}, GameBoard.PieceType.Branch), null, null},
                                                    ...
                                                    {new GameBoard.GamePiece(new GameBoard.Coordinate{x = 5, y = 0}, GameBoard.PieceType.Branch),  new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 5, y = 2}, GameBoard.PieceType.Branch),  new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 5, y = 4}, GameBoard.PieceType.Branch), new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 5, y = 6}, GameBoard.PieceType.Branch), new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 5, y = 8}, GameBoard.PieceType.Branch), new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 5, y = 8}, GameBoard.PieceType.Branch)},
                                                    ...
                                                    {null, null, new GameBoard.GamePiece(new GameBoard.Coordinate{x = 7, y = 2}, GameBoard.PieceType.Branch),  new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 7, y = 4}, GameBoard.PieceType.Branch), new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 7, y = 6}, GameBoard.PieceType.Branch), new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 7, y = 8}, GameBoard.PieceType.Branch), null, null},
                                                    ...
                                                    {null, null, null, null, new GameBoard.GamePiece(new GameBoard.Coordinate{x = 9, y = 4}, GameBoard.PieceType.Branch), new GameBoard.Tile(GameBoard.ResourceType.Red, 1), new GameBoard.GamePiece(new GameBoard.Coordinate{x = 9, y = 6}, GameBoard.PieceType.Branch), null, null, null, null},
        ...
        testFullEnclosure[7, 4].player = GameBoard.Player.Player1;
        testFullEnclosure[8, 3].player = GameBoard.Player.Player1;
        AI.CapTileChecker test1 = testAI.checkIfCaptured(testAI.AIGameBoard, (GameBoard.Tile)testFullEnclosure[5, 1], new AI.CapTileChecker(new List<GameBoard.Tile>(), false), GameBoard.Player.Player1);
